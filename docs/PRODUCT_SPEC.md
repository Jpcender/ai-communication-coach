...
Users with a real upcoming speaking need will repeatedly practice speaking into their phone.
AI-generated coaching is useful enough to change how they speak.
Some users will pay for repeated access to structured communication practice.
3. V1 Customer
...
Built-in prompts should initially focus on transferable communication behaviors rather than a large scenario catalog.

Recommended starter groups:

Explain
Explain a complicated idea simply.
...
Persuade
Convince someone to support an idea.
Recommend something you believe in.
Make the case for a decision.

These skills transfer across interviews, presentations, networking, leadership, sales, social situations, and other future scenarios.
...
onboarding
home / practice selection
recording
analysis/results
progress/history
settings/paywall when monetization is implemented
